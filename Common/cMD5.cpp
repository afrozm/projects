...
int MD5Callback::UpdateCurrent(MD5ULL currentAdd)
{
	mCurrentDone += currentAdd;
	if (mCurrentDone > mTotalBytes)
		mCurrentDone = mTotalBytes;
	return Status();
}


cMD5::cMD5(MD5Callback *pMD5Callback /*= NULL*/) : m_pMD5Callback(pMD5Callback)
{
